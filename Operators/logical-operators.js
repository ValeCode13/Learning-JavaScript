...
//  But if the eligible for loans is false !(not) operator will convert it to 'True"
let applicationRefused = !eligibleForLoan; // This is False but ! operator turn it to True.

console.log('Eligible', eligibleForLoan); // False
console.log('Refused', applicationRefused); // True